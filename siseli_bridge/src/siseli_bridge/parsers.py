...
def _quick_decode_ps4z_state(blocks: dict) -> dict:
    ...
    # PS4Z_V21_SKIP_INCOMPLETE_PV2_STATE: avoid publishing partial PV/Grid values when PV2 is missing
    ...
    try:
        ...
        _pv2 = float(out.get("pv2_power_w") or 0)
        ...
        _bat_chg_a = float(out.get("bat_charge_current") or 0)
        ...
        _bat_chg_w = float(out.get("c_battery_charge_power_w") or 0)
        ...
        _solar_sw = str(out.get("solar_charging_switch") or "").lower()
        ...
        if (
            ...
            and (_bat_chg_a > 0 or _bat_chg_w > 0 or "charg" in _status)
            ...
            # This is an incomplete telemetry frame for this inverter mapping:
            ...
            # PV1 is present but PV2 is missing, so generation/grid would be wrong.
            ...
            # Returning empty prevents overwriting the last good HA state.
